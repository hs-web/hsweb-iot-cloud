...
importMiniui(function () {
    ...
    require(["message", "miniui-tools", "request", "message"], function (message, tools, request, message) {
        ...
        /*工具栏相关*/
        {
            ...
            //按钮设置中类型的下拉列表
            mini.get("buttonTypeList").setData(buttonTypeList);
            mini.get("buttonTypeList").on("valuechanged", function (e) {
            ...
            function editToolBar(config) {
                ...
                mini.get("buttonTypeList").doValueChanged();
                $(".save-toolbar")
                    .unbind("click")
                    .on("click", function () {
                        var data = form.getData();
