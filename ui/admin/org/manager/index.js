    ...
    require(["jquery", "miniui-tools"], function ($, tools) {
        ...
        function initPerson() {
            ...
            person_grid.getColumn("action").renderer = function (e) {
                ...
                var row = e.record;
                html.push(tools.createActionButton("编辑", "icon-edit", function () {
                    tools.openWindow("admin/org/manager/person/save.html?id=" + e.record.id, "编辑人员", 800, 680, loadPerson);
                }));
                html.push(
            ...
            $(".add-person").on("click", function () {
                require(["message"], function (message) {
                    ...
                    tools.openWindow("admin/org/manager/person/save.html", "新建人员", 800, 680, loadPerson, function () {
                        var iframe = this.getIFrameEl();
                        var win = iframe.contentWindow;
